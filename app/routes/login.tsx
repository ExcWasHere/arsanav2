        ...
        <div className="text-center mb-8">
          <div className="flex flex-col items-center space-y-1">
            <img
              src="/favicon.ico"
              alt="Arsana Logo"
              className="w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 rounded-full object-cover shadow-xl"
            />
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 relative z-10">
          ...
          <div className="mt-6">
            ...
            <div className="flex justify-center space-x-4 sm:space-x-6">
              ...
              <button
                ...
                className="flex flex-col items-center space-y-2 p-2 sm:p-3 rounded-xl hover:bg-gradient-to-br hover:from-purple-50 hover:to-pink-50 transition-all duration-300 transform hover:scale-110 hover:rotate-3 group"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full flex items-center justify-center group-hover:shadow-lg group-hover:shadow-purple-300 transition-all duration-300">
                  <Smartphone className="text-white group-hover:animate-pulse" size={20} />
                </div>
              ...
              <button
                ...
                className="flex flex-col items-center space-y-2 p-2 sm:p-3 rounded-xl hover:bg-gradient-to-br hover:from-green-50 hover:to-blue-50 transition-all duration-300 transform hover:scale-110 hover:-rotate-3 group"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-400 to-blue-400 rounded-full flex items-center justify-center group-hover:shadow-lg group-hover:shadow-green-300 transition-all duration-300">
                  <Fingerprint className="text-white group-hover:animate-spin" size={20} />
                </div>
              ...
              <button
                ...
                className="flex flex-col items-center space-y-2 p-2 sm:p-3 rounded-xl hover:bg-gradient-to-br hover:from-orange-50 hover:to-red-50 transition-all duration-300 transform hover:scale-110 hover:rotate-6 group"
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-orange-400 to-red-400 rounded-full flex items-center justify-center group-hover:shadow-lg group-hover:shadow-orange-300 transition-all duration-300">
                  <Lock className="text-white group-hover:animate-bounce" size={20} />
                </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              >
                <img src="/logoGoogle.png" alt="Google" className="w-6 h-6 sm:w-7 sm:h-7" />
              ...
              >
                <img src="/logoFacebook.png" alt="Facebook" className="w-6 h-6 sm:w-7 sm:h-7" />
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-4 shadow-2xl relative w-full max-w-md">
            ...
            <button
              ...
              className="mt-4 w-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-semibold py-3 rounded-xl hover:from-cyan-500 hover:to-blue-600 transition-all duration-300 transform hover:scale-105"
            >
              OK
            </button>
            <button
