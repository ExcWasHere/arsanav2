...
const ArsanaCoursePage = () => {
  ...
  const courseData = {
    title: "Matematika - Operasi Penjumlahan",
    subtitle: "Belajar penjumlahan dengan cara yang menyenangkan!",
    grade: "Kelas 3",
    duration: "5:03",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    description: "Dalam materi ini, kamu akan belajar cara melakukan penjumlahan dengan mudah dan menyenangkan. Mulai dari penjumlahan sederhana hingga penjumlahan dengan teknik menyimpan.",
    instructor: "Bu Siti Rahayu"
  };
  ...
  const lessons = [
    { 
      ...
      duration: "3:45", 
      completed: true,
      topics: ["Apa itu penjumlahan?", "Simbol plus (+)", "Contoh sederhana"]
    },
    { 
      id: 2, 
      ...
      duration: "5:03", 
      completed: false,
      topics: ["Penjumlahan angka kecil", "Latihan soal", "Tips cepat"]
    },
    { 
      id: 3, 
    ...
    { 
      id: 4, 
      title: "Soal Cerita Penjumlahan", 
      duration: "4:55", 
      completed: false,
      topics: ["Membaca soal cerita", "Mengubah ke bentuk matematika", "Penyelesaian"]
    }
  ];

  const materialExplanation = `
    Halo teman-teman! Selamat datang di pelajaran Matematika tentang Penjumlahan! 🎉
    
    Penjumlahan adalah salah satu operasi dasar dalam matematika yang sangat penting untuk kamu kuasai. 
    
    Apa itu Penjumlahan?
    Penjumlahan adalah proses menggabungkan dua bilangan atau lebih menjadi satu bilangan yang lebih besar. Simbol yang digunakan adalah tanda plus (+).
    
    Contoh Sederhana:
    • 2 + 3 = 5 (dibaca: dua ditambah tiga sama dengan lima)
    • 5 + 4 = 9 (dibaca: lima ditambah empat sama dengan sembilan)
  ...
  const transcript = `
    ...
    [00:15] Hari ini kita akan belajar tentang penjumlahan. Penjumlahan itu mudah loh!
    ...
    [03:00] Penjumlahan itu artinya menggabungkan atau menambahkan.
            ...
            <div className="flex items-center space-x-3">
              <div className="bg-blue-50 px-4 py-2 rounded-xl">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-semibold text-blue-600">{courseData.duration}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-xl p-6 border border-white/30 sticky top-24">
              <div className="mb-6">
                <h3 className="text-xl font-bold text-gray-800 mb-2">Daftar Materi</h3>
              ...
              <div className="mt-6 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-4 border-2 border-yellow-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-800">Lanjutkan belajar!</p>
                    <p className="text-xs text-gray-600">Selesaikan semua untuk dapat lencana</p>
                  </div>
                </div>
              </div>
            </div>
